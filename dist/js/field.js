...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-unsplash', __webpack_require__(3));
  Vue.component('detail-unsplash', __webpack_require__(6));
  Vue.component('form-unsplash', __webpack_require__(9));
});
